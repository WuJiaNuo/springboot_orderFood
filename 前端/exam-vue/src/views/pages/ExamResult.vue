<template>
        ...
        <!-- 列表 -->
            ...
            <el-table-column type="selection"  :reserve-selection="true"/>
                        ...
                        <el-table-column sortable prop="sumScore" label="总分"/>
              ...
              <el-table-column label="操作" align="center" fixed="right">
                <template slot-scope="scope">
                  <el-button v-if="scope.row.score < scope.row.sumScore" @click="showExam(scope.row)" type="primary" size="mini"   >错题重做</el-button>
                </template>
              </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showExam(row) {
              this.$router.push('/joinExam?examId=' + row.examId+'&examTitle='+row.examTitle+'&endTime='+row.endTime+'&type='+row.type+'&resultId='+row.id+'&fromType=2');
            },
            //导出数据
            exportData() {
