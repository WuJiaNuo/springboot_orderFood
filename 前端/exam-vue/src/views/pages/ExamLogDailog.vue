...
<!--          <el-table-column sortable prop="deptName" label="部门名称" show-overflow-tooltip="true"/>-->
          ...
          <el-table-column sortable prop="allOption" label="选项内容" show-overflow-tooltip="true"/>
          <el-table-column sortable prop="rightOptions" label="正确选项/答案" show-overflow-tooltip="true"/>
          <el-table-column sortable prop="myOptions" label="我的选项/答案" show-overflow-tooltip="true"/>
          <el-table-column sortable prop="isRightText" label="是否正确" show-overflow-tooltip="true"/>
        </el-table>
        <el-pagination
...
<script>
import tbQuestionApi from '@/api/MyQuestionLog'
...
export default {
  ...
  methods: {
    ...
    refreshList() {
      this.loading = true;
      this.searchForm.resultId = this.resultId
